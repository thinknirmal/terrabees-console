...
<html>
    <head>
        ...
        <link href="${request.static_url('console:static/css/login.css')}" rel="stylesheet">
    </head>
    ...
    <body class="gray-bg">
        <div class="loginColumns animated fadeInDown">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h2 class="font-bold">Welcome to Terrabees</h2>
        ...
        <script src="${request.static_url('console:static/js/login.js')}"></script>
