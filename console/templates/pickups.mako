...
<div class="wrapper wrapper-content">
	<div class="row">
		...
		<div class="col-lg-4 text-right">
			<a class="btn btn-w-m btn-danger" href="/create-pickup">Create New Pickup</a>
		</div>
		<div class="col-lg-4">
			<div id="pickups-report-range" class="form-control text-center">
			...
			<div class="ibox float-e-margins">
				<div class="ibox-content">
					<div class="table-responsive">
						<table id="pickups-table-all" class="table table-striped table-bordered table-hover" >
							<thead>
								<tr>
									<th>#</th>
									<th>Docket No.</th>
